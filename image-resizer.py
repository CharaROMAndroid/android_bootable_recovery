...
DENSITIES = {
    "res-xxhdpi/images": {
        ...
        "logo_image_alt.png": (768, 480),
        "logo_image_alt_light.png": (768, 480),
    ...
    "res-xhdpi/images": {
        ...
        "logo_image_alt.png": (512, 320),
        "logo_image_alt_light.png": (512, 320),
    ...
    "res-hdpi/images": {
        ...
        "logo_image_alt.png": (384, 240),
        "logo_image_alt_light.png": (384, 240),
    ...
    "res-mdpi/images": {
        ...
        "logo_image_alt.png": (256, 160),
        "logo_image_alt_light.png": (256, 160),
